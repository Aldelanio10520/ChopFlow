...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Acesse o sistema de ordens de serviço de climatização e refrigeração." },
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-5 py-10">
      <div className="w-full max-w-sm">
        ...
        <p className="mt-4 flex items-center justify-center gap-1.5 text-center text-xs text-muted-foreground">
          Dúvidas, sugestão ou solicitar acesso de demonstração:
          <a
            href="https://wa.me/5585991869234"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex text-[#25D366] transition-opacity hover:opacity-80"
            aria-label="Falar no WhatsApp (85) 99186-9234"
            title="WhatsApp (85) 99186-9234"
          >
